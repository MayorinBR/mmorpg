...
- 属性ダメージと耐性: あらゆる攻撃が属性を持つ(通常の物理ダメージもNeutralという実在する耐性可能な属性として扱われ、「属性なし」ではない)。キャラクターごとの耐性/弱点テーブル(任意設定)がどの属性のダメージも増減させ、Poring(水に耐性、火に弱い)とPoporing(地に耐性、電気に弱い)に設定済み
